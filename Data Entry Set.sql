/*
 Name: MySQL Sample Database classicmodels2
 Link: http://www.mysqltutorial.org/mysql-sample-database.aspx
 */
/* Create the database */
CREATE DATABASE IF NOT EXISTS classicmodels2;

/* Switch to the classicmodels2 database */
USE classicmodels2;
...
(
    'Trains',
    'Model trains are a rewarding hobby for enthusiasts of all ages. Whether you\ll find a number of great choices for any budget within this category. The interactive aspect of trains makes toy trains perfect for young children. The wooden train sets are ideal for children under the age of 5.',
    NULL,
    NULL
  ),
(
...
(
    ...
    '1:18',
    'Red Start Diecast',
    '1:18 scale replica of actual Armys UH-60L BLACK HAWK Helicopter. 100% hand-assembled. Features rotating rotor blades, propeller blades and rubber wheels.',
    5330,
    '77.27',
    '157.69'
  ),
...
(
    ...
    '1:18',
    'Motor City Art Classics',
    'This 1940s Ford Pick-Up truck is re-created in 1:18 scale of original 1940s Ford truck. This antique style metal 1940s Ford Flatbed truck is all hand-assembled. This collectible 1940s Pick-Up truck is painted in classic dark green color, and features rotating wheels.',
    3128,
    '84.76',
    '121.08'
  ),
...
(
    ...
    '1:24',
    'Carousel DieCast Legends',
    'This diecast model of the 1966 Shelby Cobra 427 S/C includes many authentic details and operating parts. The 1:24 scale model of this iconic lighweight sports car from the 1960s comes in silver and its own display case.',
    8197,
    '29.18',
    '50.31'
  ),
...
(
    ...
    '2003-10-23',
    'Resolved',
    'This order was disputed, but resolved on 11/1/2003; Customer doesnt like the colors and precision of the models.',
    452
  ),
(
    10165,
...
(
    ...
    NULL,
    'Cancelled',
    'Customer called to cancel. The warehouse was notified in time and the order didnt ship. They have a new VP of Sales and are shifting their sales model. Our VP of Sales should contact them.',
    448
  ),
(
    10168,
...
(
    ...
    '2004-11-13',
    'Resolved',
    'Order was disputed and resolved on 12/1/04. The Sales Manager was involved. Customer claims the scales of the models dont match what was discussed.',
    145
  ),
(
    10328,
...
(
    ...
    '2005-01-16',
    'Resolved',
    'This order was disputed and resolved on 2/1/2005. Customer claimed that container with shipment was damaged. FedExs investigation proved this wrong.',
    205
  ),
(
    10368,
...
(
    ...
    '2005-03-06',
    'Resolved',
    'Disputed then Resolved on 3/15/2005. Customer doesnt like the craftsmaship of the models.',
    141
  ),
(
    10387,
...
(
    ...
    '2005-05-12',
    'Disputed',
    'Customer claims the scales of the models dont match what was discussed. I keep all the paperwork though to prove otherwise',
    471
  ),
(
    10416,
...
(
    ...
    '2005-05-19',
    'Disputed',
    'Customer doesnt like the colors and precision of the models.',
    141
  ),
(
    10418,
